...
export default class Parser extends Reader {
    ...
    /**
     * Sets an AppSync Butler variable for VTL file parsing. Usually, you would
     * not call this method directory. Instead, specify your variables in
     * {@link LoaderOptions.variables}
     * ```vtl title="vtl/resolvers/Mutation/addPost/request.vtl" {7}
